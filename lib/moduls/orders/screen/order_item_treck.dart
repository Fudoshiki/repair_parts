...
import 'package:repair_parts/moduls/orders/screen/track_order_screen.dart';
import 'package:repair_parts/moduls/query/screen/fullscreen_image.dart';

class OrderItemTreck extends StatelessWidget{
  bool open =false;
  bool open2=false;
  bool open3=false;
  bool open4=false;
  ...
  bool openTrack =false;
  OrderItemTreck({@required this.bottom});
                                  ...
                                  children: [
                                    Row(
                                        children:[
                                          ...
                                          SizedBox(width: 15,),
                                          openTrack?Container(): GestureDetector(
                                              child:Text(
                                                "Изменить",
                                                style: TextStyle(
                                                    fontWeight: FontWeight.w400,
