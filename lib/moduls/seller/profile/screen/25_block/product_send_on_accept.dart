...
class ProductSendOnAccept extends StatelessWidget{
  MainController _mainController =Get.find();
  bool? bottom;
  ProductSendOnAccept({@required this.bottom});
                          ...
                          child: Column(
                            ...
                            children: [
                              Container(
                                width: Get.width-136,
                                child: Text(
                                  "Товар ожидает проверки модератором",
                                  style: TextStyle(
                              ...
                              Container(
                                width: Get.width-136,
                                child: Text(
                                  "Вы можете отслеживать статус вашего товара в Личном кабинете, раздел «Оцифровка».",
                                  style: TextStyle(
