...
class OrderScreenItemSeller extends StatefulWidget {
  bool? bottom;
  OrderScreenItemSeller({@required this.bottom});
  @override
  State<StatefulWidget> createState() {
    return OrderScreenItemSellerState();
  }
}
class OrderScreenItemSellerState extends State<OrderScreenItemSeller>{
