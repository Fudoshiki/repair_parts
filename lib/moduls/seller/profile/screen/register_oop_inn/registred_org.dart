...
class RegistredOrgScreen extends StatelessWidget{
                    ...
                    children: [
                      ...
                      Container(
                          ...
                          child: TextField(
                            ...
                            enabled: false,
                            controller: new TextEditingController()..text="Ленина",
                            style: TextStyle(
                                fontWeight: FontWeight.w400,
                                fontSize: 14,
                                color: Color(0xff2e2e33),
                      ...
                      Container(
                          ...
                          child: TextField(
                            ...
                            enabled: false,
                            controller: new TextEditingController()..text="13",
                            style: TextStyle(
                                fontWeight: FontWeight.w400,
                                fontSize: 14,
                                color: Color(0xff2e2e33),
                      ...
                      Container(
                          ...
                          child: TextField(
                            ...
                            enabled: false,
                            controller: new TextEditingController()..text="3",
                            style: TextStyle(
                                fontWeight: FontWeight.w400,
                                fontSize: 14,
                                color: Color(0xff2e2e33),
                    ...
                    children: [
                      ...
                      Container(
                          ...
                          child: TextField(
                            ...
                            enabled: false,
                            controller: new TextEditingController()..text="АвтоМир",
                            style: TextStyle(
                                fontWeight: FontWeight.w400,
                                fontSize: 14,
                                color: Color(0xff2e2e33),
                            ...
                            decoration: InputDecoration(
                              ...
                              labelText: "Наименование магазина/производства",
                              labelStyle: TextStyle(
                                  fontWeight: FontWeight.w600,
                                  fontSize: 12,
                                  color: Color(0xff717171),
