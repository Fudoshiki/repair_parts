...
class CatalogScreenSellerBack extends StatelessWidget{
  MainController _mainController = Get.find();
  bool? bottom;
  CatalogScreenSellerBack({@required this.bottom});
                    ...
                    children: [
                      GestureDetector(
                        child: Container(
                          ...
                          child: Image.asset("assets/image/arrow_left.png",color: Colors.white,),
                        ),
                      ),
                      Container(
